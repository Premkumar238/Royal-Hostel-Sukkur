...
export default function PayoutsPage() {
  ...
  return (
    <AdminLayout>
      <Header title="Payouts" searchPlaceholder="Quick search..." />

      <div className="page-shell">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-sm font-bold text-gray-900">Partner Payments</h2>
            <p className="text-xs text-gray-400 mt-0.5">
              Pay Ameet Lalwani, Khairpur Home, or Sain Amjad — recorded as expenses
            </p>
          </div>
          <MonthPicker
            id="payouts-month"
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">
                          ...
                          {recipientPayments.length === 1 ? "" : "s"} this month
                        </p>
                      </div>
                      <button
                        type="button"
      ...
      {payModalRecipient && (
        <div className="modal-overlay">
          ...
          <div className="modal-panel max-w-md">
            ...
            <p className="text-xs text-gray-400 mb-6">Pay to {payModalRecipient}</p>
